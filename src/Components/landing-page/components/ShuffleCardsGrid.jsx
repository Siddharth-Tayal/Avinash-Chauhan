...
const squareData = [
  ...
  {
    id: 5,
    src: "https://images.unsplash.com/photo-1480694313141-fce5e697ee25?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YXBwJTIwZGV2ZWxvcG1lbnR8ZW58MHx8MHx8fDA%3D",
  },
  {
    id: 6,
    src: "https://images.unsplash.com/photo-1583661676511-6136039fc42a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJvbGx5d29vZCUyMGRhbmNlc3xlbnwwfHwwfHx8MA%3D%3D",
  },
  {
    id: 7,
    src: "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGFuY2UlMjBkZWNpZGVyfGVufDB8fDB8fHww",
  },
  {
    id: 8,
...
const ShuffleGrid = () => {
  ...
  return (
    <div className="grid w-[80vw] lg:w-1/2 grid-cols-3 grid-rows-4  md:grid-cols-4 md:grid-rows-4 h-[450px] gap-1">
      {squares.map((sq) => sq)}
    </div>
  );
};
